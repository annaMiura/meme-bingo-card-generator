...
const seedData = require('./seedData2.js');
...
// Model.programmerMemesModel.deleteMany({}, err => {
//   console.log('couldnt get rid of the stuff', err);
// })

Model.programmerMemesModel.insertMany(seedData.data, (err, docs) => {
